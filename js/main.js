...
// var $save = document.querySelector('form[data-view="entry-form"]');
...
function renderEntry(entry) {
  ...
  // $entryTitleDiv.setAttribute('class', 'entries hide');
...
// // 2/20 425pm stash of submit $newButton// function $submitInput(e) {
//   e.preventDefault();
//   var $newObj = {};
//   $newObj.title = document.forms[0].elements.title.value;
//   $newObj.url = document.forms[0].elements.photo.value;
